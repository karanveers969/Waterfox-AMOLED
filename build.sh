...
rm -rf patched patched-aligned.apk
...
find patched/ -type f -name "PhotonColors.smali" -exec sed -i 's/ff1c1b22/ff000000/g' {} +
find patched/ -type f -name "PhotonColors.smali" -exec sed -i 's/ff2b2a33/ff000000/g' {} +
find patched/ -type f -name "PhotonColors.smali" -exec sed -i 's/ff42414d/ff15141a/g' {} +
find patched/ -type f -name "PhotonColors.smali" -exec sed -i 's/ff52525e/ff25232e/g' {} +
find patched/ -type f -name "PhotonColors.smali" -exec sed -i 's/ff5b5b66/ff2d2b38/g' {} +
...
echo "[*] Aligning APK..."
# CHANGED: Output a clearly named, unsigned but aligned APK
